...
for path in arr:
    ...
    # Hardcoded data for the other required fields
        data = {
            ...
            "time_stamp_enter": "2024-12-29T05:26:00",  # Hardcoded timestamp
            "time_stamp_exit": "2024-12-29T07:06:00",  # Hardcoded timestamp
            "location_p": "2024-12-29T05:46:00",  # Hardcoded timestamp
            "location_r": "2024-12-29T06:46:00",  # Hardcoded timestamp
            "location_v": "2024-12-29T06:26:00",  # Hardcoded timestamp
            "location_w": "2024-12-29T06:06:00",  # Hardcoded timestamp
        }
